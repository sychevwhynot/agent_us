...
7. В корне проекта создать файл `.env` и добавить туда `API_KEY="Ключ API"`. Ключ создать [тут](https://openrouter.ai/workspaces/default/keys)
8. Запустить тесты - `python test.py`
